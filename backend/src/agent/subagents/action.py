...
from agent.tools.user import create_user, get_user_by_id, find_user_by_name, find_user_by_email, delete_user

action_agent = create_agent(
    name="Aktionsagent",
    model=get_model(),
    tools=[create_user, get_user_by_id, find_user_by_name, find_user_by_email, delete_user],
    system_prompt=(
